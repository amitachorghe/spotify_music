...
let songslist=[
    {songname:"Agar tum sath ho", path:"./1.mp3"},
    {songname:"Chahu mai ya na", path:"./audio_2.mp3"},
    {songname:"Tujhe kitna chah ne lage", path:"./audio_3.mp3"},
    {songname:"Tose naina", path:"./audio_4.mp3"},
]
